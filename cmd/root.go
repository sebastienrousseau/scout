...
func init() {
	...
	rootCmd.AddCommand(checkCmd, connectCmd, toolsCmd, callCmd, serveCmd, loginCmd, attestCmd, verifyCmd, badgeCmd, sbomCmd, overlapCmd, watchCmd, configCmd, versionCmd)
}
